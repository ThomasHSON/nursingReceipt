...
const STATUS_CAPSULE: Record<DispenseStatus, { label: string; className: string }> = {
  unexamined: { label: '待審核', className: 'bg-rose-100 text-rose-700 border border-rose-200' },
  preparing:  { label: '備藥中', className: 'bg-amber-100 text-amber-700 border border-amber-200' },
  dispense:   { label: '調配中', className: 'bg-blue-100 text-blue-700 border border-blue-200' },
